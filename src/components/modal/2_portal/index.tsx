...
const AlertTrigger = ({ id, content }: { id: string; content: string }) => {
    ...
    return (
        <>
            ...
            <AlertModal id={id} isOpen={isOpen} close={closeModal} content={content} />
        </>
    )
}
...
const FormTrigger = ({ id }: { id: string }) => {
    ...
    return (
        <>
            ...
            <FormModal id={id} onSubmit={handleSubmit} isOpen={isOpen} close={closeModal}>
                {/* Form fields go here */}
