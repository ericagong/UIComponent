...
import { useSetSnackbar, useSnackbars } from '@/context/SnackbarsContextProvider'

import cx from '../cx'

const Snackbar = ({ id, isOpen, children, onMouseEnter, onMouseLeave }: SnackbarProps) => {
    ...
    return (
        ...
        >
            <button className={cx('close-trigger')} aria-label="닫기" onClick={remove} />
            {children}
        </div>
    )
}
