...
export type ChildRoute = BaseRoute & {
    children: ComponentType<any> | null
}
...
export const routes: Record<ROUTE_PATH, ROUTE> = {
    ...
    '/infiniteScroll': {
        ...
        name: '07. 무한 스크롤',
        children: ['/infiniteScroll/1_eventHandler', '/infiniteScroll/2_intersectionObserver'],
    },
    '/infiniteScroll/1_eventHandler': {
    ...
    '/scrollSpy': {
        ...
        name: '09. 스크롤 스파이',
        children: ['/scrollSpy/1_eventHandler', '/scrollSpy/2_intersectionObserver'],
    },
    '/scrollSpy/1_eventHandler': {
